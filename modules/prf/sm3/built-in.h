...
#ifndef __OSS_CRYPTO_PRF_SM3_BUILT_IN_H__
#define __OSS_CRYPTO_PRF_SM3_BUILT_IN_H__

#define HAVE_PRF_SM3_BUILT_IN 1

#ifdef CONFIG_CC_OPTIMIZE_FOR_SIZE

void prf_sm3(struct prf_context *prf,
...
#define PRF_SM3_SCOPE static inline
#include "sm3.c"
#undef PRF_SM3_SCOPE
