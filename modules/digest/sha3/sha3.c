...
SHA3_SCOPE void sha3_512_init(struct sha3_ctx *sctx);

SHA3_SCOPE int sha3_update(struct sha3_ctx *sctx, const u8 *data, unsigned int len);
SHA3_SCOPE void sha3_final(struct sha3_ctx *sctx);
