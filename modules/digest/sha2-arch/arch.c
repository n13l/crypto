/*
 * The one translation unit of a SHA-2 backend's block glue, and nothing else.
 *
 ...
 * the bodies in arch.h behind __CRYPTO_DIGEST_SHA2_ARCH__, which is defined
 ...
 */
#define __CRYPTO_DIGEST_SHA2_ARCH__
#include "built-in.h"
