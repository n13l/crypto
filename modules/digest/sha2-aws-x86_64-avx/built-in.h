#ifndef __OSS_CRYPTO_SHA2_AWS_X86_64_AVX_BUILT_IN_H__
#define __OSS_CRYPTO_SHA2_AWS_X86_64_AVX_BUILT_IN_H__
...
extern void sha256_block_data_order_avx(struct sha256 *c, const void *in, size_t num);

static inline void
sha256_block_data_order(void *ctx, const void *in, size_t num)
{
	sha256_block_data_order_avx(ctx, in, num);
}

extern void sha512_block_data_order_avx(struct sha512 *c, const void *in, size_t num);

static inline void
sha512_block_data_order(void *ctx, const void *in, size_t num)
{
	sha512_block_data_order_avx(ctx, in, num);
}
